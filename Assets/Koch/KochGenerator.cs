...
public class KochGenerator : MonoBehaviour
{
    ...
    protected Vector3[] _initiatorPoint;
    ...
    private void OnDrawGizmos()
    {
        ...
        for (int i = 0; i < _initiatorPointAmount; i++)
        {
            ...
            Matrix4x4 rotationMaterix = Matrix4x4.TRS(transform.position, transform.rotation, transform.lossyScale);
            Gizmos.matrix = rotationMaterix;
